...
const GeminiChatPage = () => {
  ...
  const generateQuestions = async () => {
    ...
    try {
      ...
      const prompt = `Based on this document, generate 5 comprehensive practice questions. For each question:
      ...
      Please generate 5 questions following this format.`;
...
//     try {
//       const imagePart = await fileToGenerativePart(selectedFile);
//       const prompt = `Based on this document, generate 5 different practice questions mixing both multiple choice and open-ended questions. Format as follows:
...
//       Generate a mix of both types, ensuring clear formatting.`;
...
//   const parseQuestionsFromResponse = (text) => {
//     const questions = [];
//     const sections = text.split(/\[(MC|OE)\] Question:/g).filter(Boolean);

//     let currentType = null;
//     sections.forEach((section) => {
//       if (section === "MC" || section === "OE") {
//         currentType = section;
//         return;
//       }
...
//               .trim();
//           }
//         } else if (currentType === "OE") {
//           if (trimmedLine.startsWith("Model Answer:")) {
//             question.modelAnswer = trimmedLine
//               .replace("Model Answer:", "")
//               .trim();
//           }
//         }
//       });
...
//   // ... (Previous speech and chat handling functions remain the same)
...
//         response = await result.response;
//       } else {
//         const result = await textModel.generateContent(input);
//         response = await result.response;
//       }
...
//         {/* Header */}
//         <div className="bg-white rounded-t-lg shadow-lg p-4 mb-4">
...
//                     <span className="text-gray-600">PDF Document Selected</span>
//                   </div>
//                 ) : (
//                   <img
//                     src={filePreview}
